    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail_locate', models.TextField(blank=True, null=True)),
                ('current', models.IntegerField()),
                ('company_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.company')),
        ...
        migrations.CreateModel(
            name='Working',
            fields=[
                ('working_id', models.CharField(max_length=200, primary_key=True, serialize=False)),
